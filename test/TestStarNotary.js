...
it('can add the star name and star symbol properly', async () => {
    ...
    assert.equal(await instance._name(), "Oh My Stars");
    assert.equal(await instance._symbol(), "OMS");
});
...
it('lets 2 users exchange stars', async () => {
    ...
    await instance.createStar('Star 8', 8, {from: user2})
...
it('lets a user transfer a star', async () => {
    ...
    await instance.createStar('Star 9', 9, {from: user1});
...
it('lookUptokenIdToStarInfo test', async () => {
    ...
    await instance.createStar('Star 10', 10, {from: user1})

    assert.equal(await instance.lookUptokenIdToStarInfo(10), 'Star 10')
});